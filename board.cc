...
Board::Board() {
    ...
    squares.emplace_back(std::make_unique<AcademicBuilding>("AL", 1, 40, "Arts1", 50, {2, 10, 30, 90, 160, 250}));
    squares.emplace_back(std::make_unique<Square>(2, "SLC"));
    squares.emplace_back(std::make_unique<AcademicBuilding>("ML", 3, 60, "Arts1", 50, {4, 20, 60, 180, 320, 450}));
    squares.emplace_back(std::make_unique<Square>(4, "TUITION"));
    squares.emplace_back(std::make_unique<Residence>("MKV", 5, 200));
    squares.emplace_back(std::make_unique<AcademicBuilding>("ECH", 6, 100, "Arts2", 50, {6, 30, 90, 270, 400, 550}));
    squares.emplace_back(std::make_unique<Square>(7, "NEEDLES HALL"));
    squares.emplace_back(std::make_unique<AcademicBuilding>("PAS", 8, 100, "Arts2", 50, {6, 30, 90, 270, 400, 550}));
    squares.emplace_back(std::make_unique<AcademicBuilding>("HH", 9, 120, "Arts2", 50, {8, 40, 100, 300, 450, 600}));
    squares.emplace_back(std::make_unique<Square>(10, "DC Tims Line"));
    squares.emplace_back(std::make_unique<AcademicBuilding>("RCH", 11, 140, "Eng", 100, {10, 50, 150, 450, 625, 750}));
    squares.emplace_back(std::make_unique<Gym>("PAC", 12, 150));
    squares.emplace_back(std::make_unique<AcademicBuilding>("DWE", 13, 140, "Eng", 100, {10, 50, 150, 450, 625, 750}));
    squares.emplace_back(std::make_unique<AcademicBuilding>("CPH", 14, 160, "Eng", 100, {12, 60, 180, 500, 700, 900}));
    squares.emplace_back(std::make_unique<Residence>("UWP", 15, 200));
    squares.emplace_back(std::make_unique<AcademicBuilding>("LHI", 16, 180, "Health", 100, {14, 70, 200, 550, 750, 950}));
    squares.emplace_back(std::make_unique<Square>(17, "SLC"));
    squares.emplace_back(std::make_unique<AcademicBuilding>("BMH", 18, 180, "Health", 100, {14, 70, 200, 550, 750, 950}));
    squares.emplace_back(std::make_unique<AcademicBuilding>("OPT", 19, 200, "Health", 100, {16, 80, 220, 600, 800, 1000}));
    squares.emplace_back(std::make_unique<Square>(20, "Goose Nesting"));
    squares.emplace_back(std::make_unique<AcademicBuilding>("EV1", 21, 220, "Env", 150, {18, 90, 250, 700, 875, 1050}));
    squares.emplace_back(std::make_unique<Square>(22, "NEEDLES HALL"));
    squares.emplace_back(std::make_unique<AcademicBuilding>("EV2", 23, 220, "Env", 150, {18, 90, 250, 700, 875, 1050}));
    squares.emplace_back(std::make_unique<AcademicBuilding>("EV3", 24, 240, "Env", 150, {20, 100, 300, 750, 925, 1100}));
    squares.emplace_back(std::make_unique<Residence>("V1", 25, 200));
    squares.emplace_back(std::make_unique<AcademicBuilding>("PHYS", 26, 260, "Sci1", 150, {22, 110, 330, 800, 975, 1150}));
    squares.emplace_back(std::make_unique<AcademicBuilding>("B1", 27, 260, "Sci1", 150, {22, 110, 330, 800, 975, 1150}));
    squares.emplace_back(std::make_unique<Gym>("CIF", 28, 150));
    squares.emplace_back(std::make_unique<AcademicBuilding>("B2", 29, 280, "Sci1", 150, {24, 120, 360, 850, 1025, 1200}));
    squares.emplace_back(std::make_unique<Square>(30, "GO TO TIMS"));
    squares.emplace_back(std::make_unique<AcademicBuilding>("EIT", 31, 300, "Sci2", 200, {26, 130, 390, 900, 1100, 1275}));
    squares.emplace_back(std::make_unique<AcademicBuilding>("ESC", 32, 300, "Sci2", 200, {26, 130, 390, 900, 1100, 1275}));
    squares.emplace_back(std::make_unique<Square>(33, "SLC"));
    squares.emplace_back(std::make_unique<AcademicBuilding>("C2", 34, 320, "Sci2", 200, {28, 150, 450, 1000, 1200, 1400}));
    squares.emplace_back(std::make_unique<Residence>("REV", 35, 200));
    squares.emplace_back(std::make_unique<Square>(36, "NEEDLES HALL"));
    squares.emplace_back(std::make_unique<AcademicBuilding>("MC", 37, 350, "Math", 200, {35, 175, 500, 1100, 1300, 1500}));
    squares.emplace_back(std::make_unique<Square>(38, "COOP FEE"));
    squares.emplace_back(std::make_unique<AcademicBuilding>("DC", 39, 400, "Math", 200, {50, 200, 600, 1400, 1700, 2000}));
}
